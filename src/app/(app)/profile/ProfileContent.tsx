    ...
    <div className="mx-auto max-w-xl px-6 py-10 md:py-16 animate-fade-up min-h-full flex flex-col justify-center">
      ...
      >
        <div className="relative shrink-0 w-22">
          <div className="w-22 h-22 rounded-full border-2 border-accent flex items-center justify-center overflow-hidden">
            {avatarUrl ? (
              <img
                src={avatarUrl}
                alt="Avatar"
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="text-accent text-sm font-mono uppercase tracking-wider cursor-pointer hover:opacity-80"
                >
                  Save
                </button>
                <button
